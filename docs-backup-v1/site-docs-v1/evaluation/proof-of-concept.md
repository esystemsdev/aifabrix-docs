---
title: 30-Day Proof-of-Concept Plan
description: Structured 30-day plan for evaluating AI Fabrix
audience:
  - admin
  - end-user
version: stable
...
seo:
  keywords:
    ...
    - evaluation
    - 30-day plan
  canonical_url: https://docs.aifabrix.ai/evaluation/proof-of-concept
  og_image: images/proof-of-concept.png
document360:
  category: Evaluation
  visibility: public
  searchable: true
