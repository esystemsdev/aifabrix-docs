---
title: Cost & Sizing Guide
description: Cost and sizing guidance for AI Fabrix deployment
audience:
  - admin
  - end-user
version: stable
...
seo:
  keywords:
    ...
    - pricing
    - subscription tiers
  canonical_url: https://docs.aifabrix.ai/evaluation/cost-sizing
  og_image: images/cost-sizing.png
document360:
  category: Evaluation
  visibility: public
  searchable: true
